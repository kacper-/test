...
public class Main {
    ...
    private Main(final int threadCount, final int entryCount, final int valueSize,
    ...
    public static void main(String[] input) {
        ...
        Main test = new Main(threadCount, entryCount, valueSize, getPercentage, putPercentage, load);
        test.start();
    }
